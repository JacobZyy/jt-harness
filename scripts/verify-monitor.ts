...
try {
  ...
  await execute(process.execPath, [resolve(root, 'bin/jth.mjs'), 'install', '--workspace', workspace, '--project', 'jth-monitor-fixture', '--env-file', envFile], { env: { ...process.env, CODEX_HOME: home } })
